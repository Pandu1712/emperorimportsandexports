...
function ProductCard({ product }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
		...
		className: "group text-left bg-white rounded-[2.5rem] overflow-hidden border border-black/[0.04] shadow-[0_15px_45px_rgba(0,0,0,0.02)] md:hover:shadow-[0_30px_70px_rgba(0,0,0,0.06)] md:hover:-translate-y-2 transition-all duration-500 flex flex-col justify-between min-h-[370px]",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
					className: "mt-2 font-display text-xl font-bold tracking-tight text-ink leading-snug",
					children: product.name
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center gap-1.5 mt-1.5 mb-2.5",
					children: [
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					...
					className: "h-8 w-8 rounded-full border border-gold-soft/60 bg-[#fdf8f2]/30 flex items-center justify-center text-[#b45309] shadow-sm group-hover:bg-[#b45309] group-hover:text-white transition-all duration-300",

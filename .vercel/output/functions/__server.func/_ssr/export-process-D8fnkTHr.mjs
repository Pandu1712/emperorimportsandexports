...
import { C as Handshake, E as FileText, F as Award, L as ArrowRight, S as Headphones, c as Sprout, k as Clock, l as Ship, p as Package, u as Shield, w as Globe } from "../_libs/lucide-react.mjs";
import { t as hero_export_default } from "./hero-export-Dq4a_cfn.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/export-process-D8fnkTHr.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				className: "relative overflow-hidden bg-[#021d10] text-white py-10 px-8 md:px-16 text-center rounded-b-[2.5rem] z-10",
				children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 relative",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "absolute inset-0 pointer-events-none hidden lg:block z-0 px-8 py-10",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					className: "relative z-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-6 gap-x-6 lg:gap-x-8",

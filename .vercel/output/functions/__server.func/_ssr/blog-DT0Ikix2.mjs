...
import { n as rice_default, r as turmeric_default, t as products } from "./products-1CwmOwDG.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/blog-DT0Ikix2.js
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "relative overflow-hidden rounded-[2.5rem] bg-[#fdfcf7] border border-[#f2e2d2] py-20 px-8 md:px-16 text-center shadow-[0_10px_35px_rgba(0,0,0,0.02)]",
					children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pb-24 mt-6",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center justify-center gap-2",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							className: "h-9 w-9 rounded-lg border border-black/[0.05] bg-white flex items-center justify-center text-muted-foreground hover:bg-[#b45309] hover:text-white transition-colors duration-300",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							className: "h-9 w-9 rounded-lg bg-[#b45309] text-white font-semibold text-sm shadow-md",
							children: "1"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							className: "h-9 w-9 rounded-lg border border-black/[0.05] bg-white text-muted-foreground hover:bg-[#b45309]/10 hover:text-ink font-semibold text-sm transition-colors duration-300",
							children: "2"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							className: "h-9 w-9 rounded-lg border border-black/[0.05] bg-white text-muted-foreground hover:bg-[#b45309]/10 hover:text-ink font-semibold text-sm transition-colors duration-300",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							className: "h-9 px-4 rounded-lg border border-black/[0.05] bg-white flex items-center gap-1.5 text-[#b45309] font-bold text-xs hover:bg-[#b45309] hover:text-white transition-colors duration-300 shadow-sm",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Next" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowRight, { size: 12 })]
						})
					]
				})
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
				className: "bg-[#fdfcf7] border-t border-border/80 py-20 px-4 sm:px-6 lg:px-8",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {

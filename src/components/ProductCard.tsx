    ...
    >
      ...
      <div className="p-5 md:p-6 flex-1 flex flex-col justify-between">
        <div>
          ...
          {/* Title */}
          <h3 className="mt-2 font-display text-xl font-bold tracking-tight text-ink leading-snug">
            {product.name}
          </h3>
        ...
        <div className="flex justify-between items-center mt-4">
          ...
          <div className="h-8 w-8 rounded-full border border-gold-soft/60 bg-[#fdf8f2]/30 flex items-center justify-center text-[#b45309] shadow-sm group-hover:bg-[#b45309] group-hover:text-white transition-all duration-300">
            <ArrowRight size={14} />
          </div>
        </div>
      </div>

...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.emperorexportsandimports.com" },
      { property: "og:image", content: "https://www.emperorexportsandimports.com/logo-final.png" },
      ...
      { name: "twitter:image", content: "https://www.emperorexportsandimports.com/logo-final.png" },
    ],
    links: [
      { rel: "stylesheet", href: appCss },
      { rel: "icon", href: "/logo-final.png", type: "image/png" },
